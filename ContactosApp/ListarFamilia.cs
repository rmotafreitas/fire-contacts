...
{
    public partial class ListarFamilia : Form
    {
        public ListarFamilia()
        {
            InitializeComponent();
        }

        private void ListarFamilia_Load(object sender, EventArgs e)
        {
            int[] ids = Grupos.getIdsOfPeopleInIDGroup(1);
