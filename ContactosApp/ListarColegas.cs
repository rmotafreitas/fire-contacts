...
{
    public partial class ListarColegas : Form
    {
        public ListarColegas()
        {
            InitializeComponent();
        }

        private void ListarColegas_Load(object sender, EventArgs e)
        {
            int[] ids = Grupos.getIdsOfPeopleInIDGroup(4);
